    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-950">
      <div className="w-full max-w-sm text-center">
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-3 rounded-lg border border-gray-700 bg-gray-900 px-6 py-3 text-sm font-medium text-gray-100 transition hover:bg-gray-800"
        >
